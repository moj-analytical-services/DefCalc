### Note that this will not be used by the app. It is included for informative purposes only.
### It is built to run as a scraping script as and when the below code is run.
### airflow-defcalc has a copy of this script that automates the scraping (daily).
